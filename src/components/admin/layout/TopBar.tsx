...
export default function TopBar({ onMenuClick, userName, role }: Props) {
    ...
    return (
        <header className="sticky top-0 z-[150] flex items-center gap-4 h-16 px-4 sm:px-6 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800/80 flex-shrink-0">
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="hidden sm:block text-xs text-zinc-500 font-medium -mt-0.5 tracking-wide">
                    Mi Taller
                </p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
                {/* Notifications */}
                <button className="relative p-2 text-zinc-400 hover:text-white transition-colors rounded-lg hover:bg-zinc-800 focus:outline-none">
                ...
                <div className="flex items-center gap-2.5 pl-2 sm:pl-3 border-l border-zinc-800">
                    ...
                    <div className="hidden sm:block">
                        ...
                        <p className="text-[11px] text-zinc-500 mt-0.5 capitalize font-medium">{role}</p>
                    </div>
                </div>
            </div>
        </header>
